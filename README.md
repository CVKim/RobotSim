...
| 인식→제어 폐루프 (트윈, 60회) | oracle **100%** vs 인식 구동 **46.7%** → 인식 비용 53.3%p · 사이클 11.7 s/픽 | [상세 §9](docs/30_결과_상세.md#9-인식--제어-폐루프-셀-트윈에서-실제로-집어-옮기기) · `results/twin_closed_loop.json` |
...
- 폐루프는 석션 EE 를 mocap 으로 구동 — 팔 기구학·IK·충돌·석션 물리 없음. 절대값이 아니라 **oracle 대비 인식 비용**이 결과
...
| 파일 | 내용 |
|---|---|
| [docs/30_결과_상세.md](docs/30_결과_상세.md) | 결과 1~9절 전문 + 한계 + 역량 매핑 |
