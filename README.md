...
| 지표 | 클린 | ToF 노이즈 |
|---|---|---|
| 픽 중심 오차 (평균, 95% CI) | **7.8 mm** [6.2, 9.7] | **10.2 mm** [8.1, 12.6] |
| 픽 중심 오차 p95 / 최대 | 25.9 / 58.0 mm | 42.9 / 67.0 mm |
| 치수 바이어스 L / W | −8.1 / −7.7 mm | −15.4 / −14.7 mm |
| 각도 오차 | 4.8° | 5.4° |
| 깊이 오차 | +0.0 mm | +0.0 mm |
| 리콜 (잔여 ≥4개) | 0.89 | 0.82 |
| 리콜 (잔여 ≤3개) | **0.46** | **0.46** |
...
3. **잔여 소수 실패 모드** — 가득 찬 아래층 위에 박스가 1~3개만 남으면 선택기가 아래층으로 점프해
   정밀도가 0.12~0.14 로 무너진다(잔여 ≥4개에서는 0.70~0.74). 실측 시퀀스에는 이 배치가 없어 관측되지 않았다.
   **미해결 — 다음 작업 대상.**
