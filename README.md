...
| 테스트 | pytest **98** (92개는 합성 프레임만으로) · 30세션 전체 파리티 v1/v2 · 대차 4세션 파리티 · URDF↔MJCF 기구학 대조 · colcon test 39 (launch_testing 통합 5 · bag 재생) | `tests/` · `ros2_ws/.../test/` |
...
python -m pytest tests -q                                          # 98 passed (실측 데이터가 없으면 6건 skip, mujoco 가 없으면 팔·URDF 9건 skip)
