...
try {
    ...
    wsl -d Ubuntu-22.04 -e bash /mnt/e/Robot_Sim/scripts/wsl_twin_cycle_demo.sh "-" "/mnt/e/Robot_Sim/assets/ros2_twin_cycle_rviz.png" "/mnt/e/Robot_Sim/explore/ros2/twin_cycle.log" $MaxWaitS
}
finally {
